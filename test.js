...
// 内存限制： 589824KB
// 题目描述：
// 在遥远的国度有一位国王，在他手下有一支战无不胜的军队，但是他觉得这还不够，他决定继续通过训练提升军队的实力。军队中共有n名战士，其中第i位的战斗力为ai。在第i次训练中，国王会先找出战斗力最低的战士，假设他的战斗力为x，则国王会同时训练所有战斗力为x的战士，将他们的战力都提升bi (从x变为x + bi)，这样的训练一共会进行m次。同时，为了时刻了解军队的情况，国王请你帮他计算一下，在每次训练后所有战士的战斗力之和为多少。
